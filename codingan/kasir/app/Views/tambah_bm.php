        ...
        <div class="card-body">
            <div class="basic-form">
                <form class="form-horizontal form-label-left" novalidate  action="<?= base_url('home/aksi_tambah_bm')?>" method="post">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="id_barang" class="form-control text-capitalize" id="id_barang" required autocomplete="on" onchange="updateTotalHarga()">
                                ...
                                <?php foreach ($brg as $bm) {?>
                                    <option class="text-capitalize" value="<?php echo $bm->id_barang ?>"><?php echo $bm->barang ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <div class="mt-3">
                        <a href="<?= base_url('/home/barang_masuk')?>" type="submit" class="btn btn-primary">Cancel</a>
